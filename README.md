...
No more having to turn off damage over time abilities yourself on your profile when there's 9 enemies around you.<br>
...
-Mitigation<br>
    (uses every part of your classes mitigation kit on incoming raidwide attacks)<br>
-Variable Holds<br>
    (holds your cooldowns to ensure 2min bursts before the boss dies)<br>
-QOL Tweaks<br>
...
-variable holds<br>
-dot manager (where applicable)<br>
-out of combat sprint<br>
-auto burn last boss for expert maps<br>
	Class specifics:<br>
...
-variable holds<br>
-out of combat sprint<br>
-toggle resets out of combat<br> 
-auto burn last boss for expert maps<br>
	Class specifics:<br>
	-bard esuna<br>
	-bard automatic song management for dungeons<br>
	-bard dot manager<br>
